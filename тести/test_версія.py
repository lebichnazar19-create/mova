...
def test_числова_версія_вище_за_будь_який_старий_apk():
    # До d63153e buildozer/p4a рахували versionCode із рядка версії:
    # «1.2.1» -> 10201, «1.3» -> 103. Телефон із 10201 не ставить менший код
